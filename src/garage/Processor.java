...
public class Processor {
    ...
    public static void main(String[] args) {
        ...
        //действие выполнить и с какими параметрами.
        //Кол-во различных действий = кол-ву функций в ДЗ.
        System.out.println("Создать консольный пользовательский интерфейс. В котором пользователя программа будет спрашивать какое");
        System.out.println("действие выполнить и с какими параметрами.");
        System.out.println("Кол-во различных действий = кол-ву функций в ДЗ.");
